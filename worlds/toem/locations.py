...
location_table: dict[str, LocationData] = {
    ...
    LocationName.QUEST_MONSTERS: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST, (ItemName.TRIPOD, FullRegionName.OAKLAVILLE_PLAYGROUND, FullRegionName.STANHAMN_HIPPO_BEACH, FullRegionName.LOGCITY_SKATE_PARK, FullRegionName.KIIRUBERG_BLIZZARD_MONSTER)), #ItemName.HONK_ATTACHMENT, ItemName.CLIMBING_BOOTS
    ...
    LocationName.ITEM_TRIPOD: LocationData(aNone, LocationGroup.ITEM, ((FullRegionName.OAKLAVILLE_TRAIL, FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL, FullRegionName.STANHAMN_PIRATE_DRAWBRIDGE, FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_TOP, FullRegionName.LOGCITY_OVERPASS, FullRegionName.LOGCITY_OUTSIDE_GALLERY),)),
    ...
    LocationName.TAPE_FISHERMANS_WHISTLE: LocationData(FullRegionName.STANHAMN_BUS_STOP, LocationGroup.CASSETTE),
    ...
    LocationName.QUEST_YETI_CUTE: LocationData(FullRegionName.KIIRUBERG_CLIFFS, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, LocationName.COMP_FLUFF)),
    LocationName.QUEST_ICE_WIZARD: LocationData(FullRegionName.KIIRUBERG_WIZARD_TOWER, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, ItemName.HONK_ATTACHMENT, ItemName.PUFFER_HAT, ItemName.SKI_GOGGLES, ItemName.SCARF)),
    LocationName.QUEST_MILITARY_SUS: LocationData(FullRegionName.KIIRUBERG_MILITARY_BASE, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, ItemName.HONK_ATTACHMENT)),
    LocationName.QUEST_ASTRONAUT: LocationData(FullRegionName.KIIRUBERG_OBSERVATORY, LocationGroup.QUEST, (ItemName.SPACE_HELMET,)),
    LocationName.QUEST_CHALLENGE_7: LocationData(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, FullRegionName.KIIRUBERG_BIRTHDAY_PARTY, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE)),
    LocationName.QUEST_CHALLENGE_8: LocationData(FullRegionName.KIIRUBERG_CLIFFS, LocationGroup.QUEST, ((FullRegionName.KIIRUBERG_OBSERVATORY, FullRegionName.KIIRUBERG_MILITARY_BASE),)),
    LocationName.QUEST_ASTEROID: LocationData(FullRegionName.KIIRUBERG_OBSERVATORY, LocationGroup.QUEST, (FullRegionName.KIIRUBERG_SNOWMAN_SQUARE,)),
    LocationName.QUEST_GOAT_CHOIR: LocationData(FullRegionName.KIIRUBERG_FROZEN_POND, LocationGroup.QUEST, (FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP, FullRegionName.KIIRUBERG_CLIFFS)),
    ...
    LocationName.QUEST_BIRTHDAY: LocationData(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, ItemName.HONK_ATTACHMENT, ItemName.PUFFER_HAT, ItemName.SKI_GOGGLES, ItemName.SCARF, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE)),
    LocationName.QUEST_PAINTINGS: LocationData(FullRegionName.KIIRUBERG_CLIFFS, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, FullRegionName.KIIRUBERG_FROZEN_POND, FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE, FullRegionName.MOUNTAIN_TOP_BUS_STOP)),
    LocationName.QUEST_BECOME_YETI: LocationData(FullRegionName.KIIRUBERG_SKI_LIFT_BASE, LocationGroup.QUEST),
    LocationName.QUEST_SNOWMAN: LocationData(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, ItemName.HONK_ATTACHMENT, FullRegionName.KIIRUBERG_SKI_LIFT_BASE, FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP)),
    ...
    LocationName.COMP_FLUFF: LocationData(FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY, LocationGroup.COMPENDIUM),
    LocationName.COMP_HEDGEHOG: LocationData(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY, LocationGroup.COMPENDIUM),
    LocationName.COMP_METEOPAL: LocationData(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE, LocationGroup.COMPENDIUM, (FullRegionName.KIIRUBERG_OBSERVATORY,)),
    LocationName.COMP_GOAT: LocationData(None, LocationGroup.COMPENDIUM, ((FullRegionName.KIIRUBERG_FROZEN_POND, FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP, FullRegionName.KIIRUBERG_CLIFFS),)),
    LocationName.COMP_OWL: LocationData(FullRegionName.KIIRUBERG_CLIFFS, LocationGroup.COMPENDIUM),
    LocationName.COMP_SNOW_BIRD: LocationData(FullRegionName.KIIRUBERG_SKI_LIFT_BASE, LocationGroup.COMPENDIUM),
    LocationName.COMP_TATO_ALIEN: LocationData(FullRegionName.KIIRUBERG_OBSERVATORY, LocationGroup.COMPENDIUM, (ItemName.CLIMBING_BOOTS,)),
    ...
    LocationName.ITEM_SPACE_HELMET: LocationData(FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY, LocationGroup.ITEM, (ItemName.CLIMBING_BOOTS,)),
    ...
    LocationName.CHEEVO_GEARED_UP: LocationData(None, LocationGroup.ACHIEVEMENT, (ItemName.CLIMBING_BOOTS, ItemName.PUFFER_HAT, ItemName.SKI_GOGGLES, ItemName.SCARF)),
    LocationName.CHEEVO_HURDLE: LocationData(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE, LocationGroup.ACHIEVEMENT, (LocationName.QUEST_CHALLENGE_7, LocationName.QUEST_CHALLENGE_8)),
    ...
    LocationName.CHEEVO_STORY: LocationData(FullRegionName.KIIRUBERG_CLIFFS, LocationGroup.ACHIEVEMENT, (LocationName.QUEST_PAINTINGS,)),
