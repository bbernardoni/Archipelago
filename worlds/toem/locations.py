...
location_table: dict[str, LocationData] = {
    ...
    LocationName.QUEST_PAINTINGS: LocationData(RegionName.KIIRUBERG_CLIFFS_MIDDLE, LocationGroup.QUEST,
            Has(ItemName.CLIMBING_BOOTS) & CanReachAllRegions(RegionName.KIIRUBERG_FROZEN_POND,
                RegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM, RegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM,
    ...
    LocationName.COMP_FLUFF: LocationData(RegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM, LocationGroup.COMPENDIUM),
    ...
    LocationName.ITEM_SPACE_HELMET: LocationData(RegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM, LocationGroup.ITEM),
    ...
    LocationName.TAPE_TALL_SHY: LocationData(RegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT, LocationGroup.CASSETTE,
            warm_clothes),
