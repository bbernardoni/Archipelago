...
location_table: dict[str, LocationData] = {
    ...
    LocationName.QUEST_HIDDEN_GIFT: LocationData(RegionName.HOMELANDA, LocationGroup.QUEST, (ItemName.CLOGS,)),
    LocationName.QUEST_EXPERIENCE_TOEM: LocationData(RegionName.HOMELANDA, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS,)),
    LocationName.COMP_COW: LocationData(RegionName.HOMELANDA, LocationGroup.COMPENDIUM),
    LocationName.COMP_FLIES: LocationData(RegionName.HOMELANDA, LocationGroup.COMPENDIUM),
    LocationName.COMP_HOME_BIRD: LocationData(RegionName.HOMELANDA, LocationGroup.COMPENDIUM),
    LocationName.COMP_TATO: LocationData(RegionName.HOMELANDA, LocationGroup.COMPENDIUM),
    LocationName.ITEM_CLOGS: LocationData(RegionName.HOMELANDA, LocationGroup.ITEM),
    LocationName.ITEM_AWARD_MASK: LocationData(RegionName.HOMELANDA, LocationGroup.ITEM, (ItemName.HONK_ATTACHMENT,)),
    LocationName.TAPE_PHOTO_OF_HOME: LocationData(RegionName.HOMELANDA, LocationGroup.CASSETTE),
    LocationName.CHEEVO_BEGINNING: LocationData(RegionName.HOMELANDA, LocationGroup.ACHIEVEMENT),
    LocationName.CHEEVO_HOME_SWEET_HOME: LocationData(RegionName.HOMELANDA, LocationGroup.ACHIEVEMENT),
    LocationName.QUEST_SUS_FOREST: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST),
    LocationName.QUEST_MONSTERS: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST, (ItemName.TRIPOD, ItemName.HONK_ATTACHMENT, ItemName.CLIMBING_BOOTS)),
    LocationName.QUEST_SOCKS: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST, (ItemName.WET_SOCKS,)),
    LocationName.QUEST_SCOUTS: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST),
    LocationName.QUEST_HIDE_AND_SEEK: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST),
    LocationName.QUEST_LOG_JAM: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST),
    LocationName.QUEST_CHALLENGE_1: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST),
    LocationName.QUEST_CHALLENGE_2: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST),
    LocationName.QUEST_PAPARAZZI: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST, (ItemName.GHOST_GLASSES,)),
    LocationName.QUEST_CAPTURE_HOTEL: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST),
    LocationName.QUEST_HOTEL_CHEF: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST),
    LocationName.QUEST_STALLION: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST, (ItemName.GHOST_GLASSES,)),
    LocationName.QUEST_GHOST_HELPER: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST, (ItemName.GHOST_GLASSES, ItemName.HONK_ATTACHMENT, ItemName.SANDWICH)),
    LocationName.QUEST_CUP_CHAMP: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST, (ItemName.GHOST_GLASSES,)),
    LocationName.QUEST_FLOWER: LocationData(RegionName.OAKLAVILLE, LocationGroup.QUEST),
    LocationName.COMP_ANT: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_BEEHIVE: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_BUTTERFLY: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_OSKAR: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_SERO: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_FOREST_BIRD: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_LADYBUG: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_TOM: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_NESTWORM: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_PET_ROCK: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_SNAIL: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_SQUIRREL: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_STAG_BEETLE: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_TATO_BUG: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.COMP_TATO_FLY: LocationData(RegionName.OAKLAVILLE, LocationGroup.COMPENDIUM),
    LocationName.ITEM_FINGER: LocationData(RegionName.OAKLAVILLE, LocationGroup.ITEM),
    LocationName.ITEM_TRIPOD: LocationData(RegionName.OAKLAVILLE, LocationGroup.ITEM),
    LocationName.ITEM_COWBOY_HAT: LocationData(RegionName.OAKLAVILLE, LocationGroup.ITEM),
    LocationName.ITEM_WET_SOCKS: LocationData(RegionName.OAKLAVILLE, LocationGroup.ITEM, (ItemName.GHOST_GLASSES,)),
    LocationName.ITEM_FJALLBJORN_HAT: LocationData(RegionName.OAKLAVILLE, LocationGroup.ITEM),
    ...
    LocationName.CHEEVO_SLOW_AND_STEADY: LocationData(RegionName.OAKLAVILLE, LocationGroup.ACHIEVEMENT),
    LocationName.CHEEVO_NATURE_SHOWSTOPPER: LocationData(RegionName.OAKLAVILLE, LocationGroup.ACHIEVEMENT),
    LocationName.CHEEVO_STRONG_AS_AN_OAK: LocationData(RegionName.OAKLAVILLE, LocationGroup.ACHIEVEMENT, (ItemName.GHOST_GLASSES, ItemName.WET_SOCKS, ItemName.TRIPOD, ItemName.HONK_ATTACHMENT, ItemName.CLIMBING_BOOTS, ItemName.SANDWICH)),
    ...
    LocationName.QUEST_CHALLENGE_3: LocationData(RegionName.STANHAMN, LocationGroup.QUEST),
    LocationName.QUEST_CHALLENGE_4: LocationData(RegionName.STANHAMN, LocationGroup.QUEST, (ItemName.HONK_ATTACHMENT,)),
    LocationName.QUEST_FRAMES_FILTERS: LocationData(RegionName.STANHAMN, LocationGroup.QUEST, (ItemName.FRAMES_FILTERS,)),
    LocationName.QUEST_TAKE_A_BATH: LocationData(RegionName.STANHAMN, LocationGroup.QUEST, (ItemName.HONK_ATTACHMENT,)),
    LocationName.QUEST_LOST_DOG: LocationData(RegionName.STANHAMN, LocationGroup.QUEST, (ItemName.HONK_ATTACHMENT,)),
    ...
    LocationName.COMP_WILLEMIJN: LocationData(RegionName.STANHAMN, LocationGroup.COMPENDIUM, (ItemName.HONK_ATTACHMENT,)),
    LocationName.COMP_CRAB: LocationData(RegionName.STANHAMN, LocationGroup.COMPENDIUM),
    ...
    LocationName.COMP_TATO_SCUBA: LocationData(RegionName.STANHAMN, LocationGroup.COMPENDIUM, (ItemName.HONK_ATTACHMENT, ItemName.DIVING_HELMET)),
    LocationName.COMP_TATO_SWIM: LocationData(RegionName.STANHAMN, LocationGroup.COMPENDIUM),
    LocationName.COMP_TOAD: LocationData(RegionName.STANHAMN, LocationGroup.COMPENDIUM),
    LocationName.ITEM_FRAMES_FILTERS: LocationData(RegionName.STANHAMN, LocationGroup.ITEM),
    LocationName.ITEM_FISHING_HAT: LocationData(RegionName.STANHAMN, LocationGroup.ITEM),
    LocationName.ITEM_HONK_ATTACHMENT: LocationData(RegionName.STANHAMN, LocationGroup.ITEM),
    LocationName.ITEM_UMBRELLA: LocationData(RegionName.STANHAMN, LocationGroup.ITEM, (ItemName.HONK_ATTACHMENT,)),
    LocationName.ITEM_OLD_KEY: LocationData(RegionName.STANHAMN, LocationGroup.ITEM, (ItemName.HONK_ATTACHMENT,)),
    LocationName.ITEM_HARD_HAT: LocationData(RegionName.STANHAMN, LocationGroup.ITEM, (ItemName.HONK_ATTACHMENT,)),
    LocationName.ITEM_DIVING_HELMET: LocationData(RegionName.STANHAMN, LocationGroup.ITEM, (ItemName.HONK_ATTACHMENT,)),
    LocationName.ITEM_RUBBER_BOOTS: LocationData(RegionName.STANHAMN, LocationGroup.ITEM, (ItemName.HONK_ATTACHMENT,)),
    LocationName.ITEM_SANDWICH: LocationData(RegionName.STANHAMN, LocationGroup.ITEM, (ItemName.HONK_ATTACHMENT,ItemName.GHOST_GLASSES)),
    ...
    LocationName.QUEST_SUS_CITY: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_RATSKULLZ: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_PUNK_ROCKER: LocationData(RegionName.LOGCITY, LocationGroup.QUEST, (ItemName.CINNAMON_BUN,)),
    LocationName.QUEST_CHALLENGE_5: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_CHALLENGE_6: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_NEWS: LocationData(RegionName.LOGCITY, LocationGroup.QUEST, (ItemName.REPORTER_HAT,)),
    LocationName.QUEST_SEWER: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_HOTBEAN: LocationData(RegionName.LOGCITY, LocationGroup.QUEST, (ItemName.HOTBEAN_HAT,)),
    LocationName.QUEST_HANG_IN_THERE: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_SCARY_CITY: LocationData(RegionName.LOGCITY, LocationGroup.QUEST, (ItemName.GHOST_GLASSES,)),
    LocationName.QUEST_DATE: LocationData(RegionName.LOGCITY, LocationGroup.QUEST, (ItemName.GHOST_GLASSES,)),
    LocationName.QUEST_ART: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_INFLUENCER: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_FASHION: LocationData(RegionName.LOGCITY, LocationGroup.QUEST, (ItemName.REPORTER_HAT, ItemName.HOTBEAN_HAT)), # second hat is assumed to be hotbean since that's already needed
    LocationName.QUEST_CLEANING: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_GRANNY: LocationData(RegionName.LOGCITY, LocationGroup.QUEST),
    LocationName.QUEST_MICE: LocationData(RegionName.LOGCITY, LocationGroup.QUEST, (ItemName.HONK_ATTACHMENT,)),
    LocationName.QUEST_CROW: LocationData(RegionName.LOGCITY, LocationGroup.QUEST, (ItemName.FRISBEE,)),
    LocationName.COMP_BUSINESS_PIGEON: LocationData(RegionName.LOGCITY, LocationGroup.COMPENDIUM),
    LocationName.COMP_PORTILLO: LocationData(RegionName.LOGCITY, LocationGroup.COMPENDIUM),
    LocationName.COMP_MOUSE: LocationData(RegionName.LOGCITY, LocationGroup.COMPENDIUM),
    LocationName.COMP_PIGEON: LocationData(RegionName.LOGCITY, LocationGroup.COMPENDIUM),
    LocationName.COMP_PUNK_PARROT: LocationData(RegionName.LOGCITY, LocationGroup.COMPENDIUM, (ItemName.CINNAMON_BUN,)),
    LocationName.COMP_TATO_SKATEBOARD: LocationData(RegionName.LOGCITY, LocationGroup.COMPENDIUM),
    LocationName.COMP_TATO_TOURIST: LocationData(RegionName.LOGCITY, LocationGroup.COMPENDIUM),
    LocationName.COMP_TURTLE: LocationData(RegionName.LOGCITY, LocationGroup.COMPENDIUM),
    LocationName.ITEM_HOTBEAN_HAT: LocationData(RegionName.LOGCITY, LocationGroup.ITEM),
    LocationName.ITEM_REPORTER_HAT: LocationData(RegionName.LOGCITY, LocationGroup.ITEM),
    ...
    LocationName.QUEST_ICE_WIZARD: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, ItemName.HONK_ATTACHMENT, ItemName.PUFFER_HAT, ItemName.SKI_GOGGLES, ItemName.SCARF)),
    LocationName.QUEST_MILITARY_SUS: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, ItemName.HONK_ATTACHMENT)),
    LocationName.QUEST_ASTRONAUT: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, ItemName.SPACE_HELMET)),
    LocationName.QUEST_CHALLENGE_7: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS,)),
    LocationName.QUEST_CHALLENGE_8: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS,)),
    LocationName.QUEST_ASTEROID: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS,)),
    LocationName.QUEST_GOAT_CHOIR: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST),
    LocationName.QUEST_SNOWBALL: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS,)),
    LocationName.QUEST_BIRTHDAY: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, ItemName.HONK_ATTACHMENT, ItemName.PUFFER_HAT, ItemName.SKI_GOGGLES, ItemName.SCARF)),
    LocationName.QUEST_PAINTINGS: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS,)),
    LocationName.QUEST_BECOME_YETI: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST),
    LocationName.QUEST_SNOWMAN: LocationData(RegionName.KIIRUBERG, LocationGroup.QUEST, (ItemName.CLIMBING_BOOTS, ItemName.HONK_ATTACHMENT)),
    LocationName.COMP_MIKEE: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM),
    LocationName.COMP_NARIKO: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM),
    LocationName.COMP_COSMO_DEER: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM, (ItemName.CLIMBING_BOOTS, ItemName.HONK_ATTACHMENT, ItemName.PUFFER_HAT, ItemName.SKI_GOGGLES, ItemName.SCARF)),
    LocationName.COMP_TEDDY: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM, (ItemName.CLIMBING_BOOTS,)),
    LocationName.COMP_FLUFF: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM),
    LocationName.COMP_HEDGEHOG: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM),
    LocationName.COMP_METEOPAL: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM, (ItemName.CLIMBING_BOOTS,)),
    LocationName.COMP_GOAT: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM),
    LocationName.COMP_OWL: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM),
    LocationName.COMP_SNOW_BIRD: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM),
    LocationName.COMP_TATO_ALIEN: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM, (ItemName.CLIMBING_BOOTS,)),
    LocationName.COMP_TATO_SKI: LocationData(RegionName.KIIRUBERG, LocationGroup.COMPENDIUM),
    LocationName.ITEM_CLIMBING_BOOTS: LocationData(RegionName.KIIRUBERG, LocationGroup.ITEM),
    LocationName.ITEM_PUFFER_HAT: LocationData(RegionName.KIIRUBERG, LocationGroup.ITEM, (ItemName.CLIMBING_BOOTS,)),
    ...
    LocationName.QUEST_FRUITS: LocationData(RegionName.BASTO, LocationGroup.QUEST, (ItemName.WATERGUN, ItemName.BANAKIN, ItemName.MELONEAR, ItemName.BEANUT, ItemName.ORANGANAS)),
    LocationName.QUEST_BRAIN_FREEZE: LocationData(RegionName.BASTO, LocationGroup.QUEST, (ItemName.WATERGUN, ItemName.PICKAXE, ItemName.ICE_CREAM)),
    LocationName.QUEST_SWEET_TOOTH: LocationData(RegionName.BASTO, LocationGroup.QUEST, (ItemName.WATERGUN, ItemName.ICE_CREAM)),
    LocationName.QUEST_IN_YOUR_FACE: LocationData(RegionName.BASTO, LocationGroup.QUEST, (ItemName.WATERGUN, ItemName.ICE_CREAM)),
    LocationName.QUEST_BROKEN_DREAMS: LocationData(RegionName.BASTO, LocationGroup.QUEST, (ItemName.WATERGUN, ItemName.ICE_CREAM)),
    ...
    LocationName.COMP_SNAKE: LocationData(RegionName.BASTO, LocationGroup.COMPENDIUM, (ItemName.WATERGUN,)),
    LocationName.COMP_BEAK_BIRD: LocationData(RegionName.BASTO, LocationGroup.COMPENDIUM),
    LocationName.COMP_BITLING_FROG: LocationData(RegionName.BASTO, LocationGroup.COMPENDIUM, (ItemName.WATERGUN,)),
    LocationName.COMP_BITLING_MOUSE: LocationData(RegionName.BASTO, LocationGroup.COMPENDIUM, (ItemName.WATERGUN, ItemName.ICE_CREAM)),
    LocationName.COMP_BITLING_SNAIL: LocationData(RegionName.BASTO, LocationGroup.COMPENDIUM, (ItemName.WATERGUN,)),
    LocationName.COMP_BITLING_TATO: LocationData(RegionName.BASTO, LocationGroup.COMPENDIUM),
    LocationName.COMP_COCO_CRAB: LocationData(RegionName.BASTO, LocationGroup.COMPENDIUM, (ItemName.WATERGUN,)),
    LocationName.COMP_DAY_LIZARD: LocationData(RegionName.BASTO, LocationGroup.COMPENDIUM, (ItemName.WATERGUN,)),
    LocationName.COMP_DRILL_MOLE: LocationData(RegionName.BASTO, LocationGroup.COMPENDIUM, (ItemName.WATERGUN,)),
    ...
    LocationName.ITEM_ICE_CREAM_BEANUT: LocationData(RegionName.BASTO, LocationGroup.ITEM, (ItemName.WATERGUN, ItemName.BEANUT)),
    LocationName.ITEM_ICE_CREAM_ORANGANAS: LocationData(RegionName.BASTO, LocationGroup.ITEM, (ItemName.WATERGUN, ItemName.ORANGANAS)),
    LocationName.ITEM_ROYAL_CAPE: LocationData(RegionName.BASTO, LocationGroup.ITEM, (ItemName.WATERGUN, ItemName.ICE_CREAM)),
    LocationName.ITEM_MINIGAME_TICKET: LocationData(RegionName.BASTO, LocationGroup.ITEM, (ItemName.WATERGUN,)),
    LocationName.ITEM_LEI: LocationData(RegionName.BASTO, LocationGroup.ITEM, (ItemName.WATERGUN, ItemName.MINIGAME_TICKET)),
