...
location_table: dict[str, LocationData] = {
    ...
    LocationName.QUEST_BAD_HAIR_DAY: LocationData(RegionName.BAD_HAIR_DAY, LocationGroup.QUEST,
    ...
    LocationName.QUEST_BRAIN_FREEZE: LocationData(RegionName.BASTO_BONFIRE_TOP, LocationGroup.QUEST,
            (Has(ItemName.ICE_CREAM, 4) | HardLogic(Has(ItemName.ICE_CREAM))) & Has(ItemName.PICKAXE)),
    LocationName.QUEST_SWEET_TOOTH: LocationData(RegionName.BASTO_CAVE, LocationGroup.QUEST,
            (Has(ItemName.ICE_CREAM, 4) | HardLogic(Has(ItemName.ICE_CREAM))) & # TODO proper glitch logic
            CanReachLocation(LocationName.QUEST_BATS)),
    ...
    LocationName.QUEST_BATS: LocationData(RegionName.BASTO_CAVE, LocationGroup.QUEST,
            (HasAny(ItemName.WATERGUN, ItemName.HONK_ATTACHMENT) & CanReachAllRegions(RegionName.BASTO_BONFIRE_TOP,
                RegionName.BASTO_OUTSIDE_CASTLE)) | HardLogic(Has(ItemName.WATERGUN)) &
                CanReachAllRegions(RegionName.BASTO_BONFIRE_BOTTOM, RegionName.BASTO_OUTSIDE_CASTLE)),
    ...
    LocationName.COMP_DRILL_MOLE: LocationData(RegionName.DRILL_MOLE, LocationGroup.COMPENDIUM),
    ...
    LocationName.COMP_NIGHT_LIZARD: LocationData(RegionName.NIGHT_LIZARD, LocationGroup.COMPENDIUM),
    ...
    LocationName.TAPE_SAILORS_TUNE: LocationData(RegionName.BASTO_BUS_STOP_BOTTOM, LocationGroup.CASSETTE,
            bonfire_rule),
    LocationName.TAPE_SONG_OF_THE_SEA: LocationData(RegionName.SONG_OF_THE_SEA, LocationGroup.CASSETTE,
            Has(ItemName.WATERGUN)),
    ...
    LocationName.CHEEVO_MOONLIT_BEAUTY: LocationData(RegionName.BAD_HAIR_DAY, LocationGroup.ACHIEVEMENT,
