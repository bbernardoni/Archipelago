...
oaklaville_regions = (
    ...
    FullRegionName.OAKLAVILLE_HOTEL_ELEVATOR, FullRegionName.OAKLAVILLE_GHOST_CUP_GAME,
    FullRegionName.OAKLAVILLE_MUSHROOM_HOUSE, FullRegionName.OAKLAVILLE_HIDE_AND_SEEK,
    FullRegionName.OAKLAVILLE_GRAVEYARD, FullRegionName.OAKLAVILLE_SKELETON_HOUSE,
    FullRegionName.OAKLAVILLE_SKELETON_HOUSE_BALCONY, FullRegionName.OAKLAVILLE_CAMP,
    FullRegionName.OAKLAVILLE_TRAIL_TOP, FullRegionName.OAKLAVILLE_TRAIL_BOTTOM, FullRegionName.OAKLAVILLE_LOOKOUT,
    FullRegionName.OAKLAVILLE_PLAYGROUND, FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_TOP,
    FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_BOTTOM, FullRegionName.OAKLAVILLE_RAVE
)
stanhamn_regions = (
    FullRegionName.STANHAMN_BUS_STOP, FullRegionName.STANHAMN_PHOTO_GUILD_HUT,
    FullRegionName.STANHAMN_PIRATE_DRAWBRIDGE, FullRegionName.STANHAMN_HIPPO_BEACH, FullRegionName.STANHAMN_UNDERWATER,
    FullRegionName.STANHAMN_OUTSIDE_LIGHTHOUSE, FullRegionName.STANHAMN_LIGHTHOUSE,
    FullRegionName.STANHAMN_LIGHTHOUSE_ROOF, FullRegionName.STANHAMN_KING_FISH_BEACH,
...
logcity_regions = (
    FullRegionName.LOGCITY_BUS_STOP, FullRegionName.LOGCITY_CLOCK_TOWER, FullRegionName.LOGCITY_CROSSWALK,
    FullRegionName.LOGCITY_OVERPASS, FullRegionName.LOGCITY_NEWS_HOUSE, FullRegionName.LOGCITY_SKATE_PARK,
    FullRegionName.LOGCITY_RATSKULLZ_ALLEY, FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW,
    FullRegionName.LOGCITY_FASHION_SHOW_TOP, FullRegionName.LOGCITY_FASHION_SHOW_BOTTOM,
...
kiiruberg_regions = (
    FullRegionName.KIIRUBERG_BUS_STOP, FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM,
    FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_TOP, FullRegionName.KIIRUBERG_BALLOON_HOUSE,
    FullRegionName.KIIRUBERG_FROZEN_POND, FullRegionName.KIIRUBERG_OLD_MANS_HOUSE,
    FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_TOP,
    FullRegionName.KIIRUBERG_MILITARY_BASE, FullRegionName.KIIRUBERG_MECKS_HOUSE,
    FullRegionName.KIIRUBERG_OUTSIDE_WIZARD_TOWER, FullRegionName.KIIRUBERG_WIZARD_TOWER,
    FullRegionName.KIIRUBERG_COSMO_GARDEN, FullRegionName.KIIRUBERG_CLIFFS_BOTTOM,
    FullRegionName.KIIRUBERG_CLIFFS_MIDDLE, FullRegionName.KIIRUBERG_CLIFFS_TOP,
    FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT,
    FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_RIGHT, FullRegionName.KIIRUBERG_MAN_CAVE,
    FullRegionName.KIIRUBERG_BLIZZARD_MONSTER, FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_TOP,
    FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM, FullRegionName.KIIRUBERG_OBSERVATORY,
    FullRegionName.KIIRUBERG_SKI_LIFT_BASE, FullRegionName.KIIRUBERG_SKI_LODGE,
