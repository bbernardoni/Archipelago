...
class FullRegionName:
    ...
    OAKLAVILLE_SKELETON_BALCONY = f"{RegionName.OAKLAVILLE} - Skeleton house balcony"
...
oaklaville_regions = (
    ...
    FullRegionName.OAKLAVILLE_SKELETON_BALCONY, FullRegionName.OAKLAVILLE_CAMP, FullRegionName.OAKLAVILLE_TRAIL_TOP,
    FullRegionName.OAKLAVILLE_TRAIL_BOTTOM, FullRegionName.OAKLAVILLE_LOOKOUT, FullRegionName.OAKLAVILLE_PLAYGROUND,
    FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_TOP, FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_BOTTOM,
