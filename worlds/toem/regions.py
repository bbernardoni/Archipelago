...
class RegionName:
    ...
    KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT = f"{Area.KIIRUBERG} - Blizzard bridge lower left"
    KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT = f"{Area.KIIRUBERG} - Blizzard bridge upper left"
    ...
    KIIRUBERG_OUTSIDE_OBSERVATORY_TOP = f"{Area.KIIRUBERG} - Outside observatory top"
    KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM = f"{Area.KIIRUBERG} - Outside observatory bottom"
...
kiiruberg_regions = (
    ...
    RegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT, RegionName.KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT,
    RegionName.KIIRUBERG_BLIZZARD_BRIDGE_RIGHT, RegionName.KIIRUBERG_MAN_CAVE,
    RegionName.KIIRUBERG_BLIZZARD_MONSTER, RegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_TOP,
    RegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM, RegionName.KIIRUBERG_OBSERVATORY,
