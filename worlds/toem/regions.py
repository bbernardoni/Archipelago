...
class SubRegionName:
    ...
    OAKLAVILLE_TRAIL_TOP = "Trail top"
    OAKLAVILLE_TRAIL_BOTTOM = "Trail bottom"
    OAKLAVILLE_LOOKOUT = "Lookout"
    OAKLAVILLE_PLAYGROUND = "Playground"
    OAKLAVILLE_OUTSIDE_RAVE_TOP = "Outside rave top"
    OAKLAVILLE_OUTSIDE_RAVE_BOTTOM = "Outside rave bottom"
    ...
    LOGCITY_FASHION_SHOW_TOP = "Fashion show top"
    LOGCITY_FASHION_SHOW_BOTTOM = "Fashion show bottom"
    ...
    # Basto
    BASTO_BUS_STOP_TOP = "Harbor top"
    BASTO_BUS_STOP_BOTTOM = "Harbor bottom"
    BASTO_LILY_PAD_POND_LEFT = "Lily pad pond left"
    ...
    BASTO_BONFIRE_BOTTOM = "Bonfire bottom"
...
class FullRegionName:
    ...
    OAKLAVILLE_TRAIL_TOP = f"{RegionName.OAKLAVILLE} - {SubRegionName.OAKLAVILLE_TRAIL_TOP}"
    OAKLAVILLE_TRAIL_BOTTOM = f"{RegionName.OAKLAVILLE} - {SubRegionName.OAKLAVILLE_TRAIL_BOTTOM}"
    ...
    OAKLAVILLE_OUTSIDE_RAVE_TOP = f"{RegionName.OAKLAVILLE} - {SubRegionName.OAKLAVILLE_OUTSIDE_RAVE_TOP}"
    OAKLAVILLE_OUTSIDE_RAVE_BOTTOM = f"{RegionName.OAKLAVILLE} - {SubRegionName.OAKLAVILLE_OUTSIDE_RAVE_BOTTOM}"
    ...
    LOGCITY_FASHION_SHOW_TOP = f"{RegionName.LOGCITY} - {SubRegionName.LOGCITY_FASHION_SHOW_TOP}"
    LOGCITY_FASHION_SHOW_BOTTOM = f"{RegionName.LOGCITY} - {SubRegionName.LOGCITY_FASHION_SHOW_BOTTOM}"
    ...
    # Basto
    BASTO_BUS_STOP_TOP = f"{RegionName.BASTO} - {SubRegionName.BASTO_BUS_STOP_TOP}"
    BASTO_BUS_STOP_BOTTOM = f"{RegionName.BASTO} - {SubRegionName.BASTO_BUS_STOP_BOTTOM}"
    BASTO_LILY_PAD_POND_LEFT = f"{RegionName.BASTO} - {SubRegionName.BASTO_LILY_PAD_POND_LEFT}"
    ...
    BASTO_BONFIRE_BOTTOM = f"{RegionName.BASTO} - {SubRegionName.BASTO_BONFIRE_BOTTOM}"
