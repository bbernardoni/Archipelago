...
region_connections: dict[str, list[Connection]] = {
    # Menu
    FullRegionName.START_MENU: [
        Connection(FullRegionName.HOMELANDA_PLAYER_ROOM, "Start game", ERGroups.EXCLUDED),
    ],
    FullRegionName.BUS_MENU: [
    ...
    FullRegionName.HOMELANDA_BUS_STOP: [
    ...
    # Oaklaville
    FullRegionName.OAKLAVILLE_BUS_STOP: [
    ...
    FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL: [
    ...
    FullRegionName.OAKLAVILLE_GRAVEYARD: [
    ...
    FullRegionName.OAKLAVILLE_SKELETON_HOUSE: [
    ...
    FullRegionName.OAKLAVILLE_TRAIL_TOP: [
    ...
    FullRegionName.OAKLAVILLE_TRAIL_BOTTOM: [
    ...
    FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_TOP: [
    ...
    FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_BOTTOM: [
    ...
    # Stanhamn
    FullRegionName.STANHAMN_BUS_STOP: [
    ...
    FullRegionName.STANHAMN_HIPPO_BEACH: [
    ...
    FullRegionName.STANHAMN_LIGHTHOUSE: [
    ...
    FullRegionName.STANHAMN_FISHING_TOWER: [
    ...
    FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_BOTTOM: [
    ...
    FullRegionName.STANHAMN_OUTSIDE_HYDROPLANT: [
    ...
    FullRegionName.STANHAMN_HYDROPLANT: [
    ...
    FullRegionName.LOGCITY_CLOCK_TOWER: [
    ...
    FullRegionName.LOGCITY_CROSSWALK: [
    ...
    FullRegionName.LOGCITY_OVERPASS: [
    ...
    FullRegionName.LOGCITY_FASHION_SHOW_TOP: [
    ...
    FullRegionName.LOGCITY_FASHION_SHOW_BOTTOM: [
    ...
    FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM: [
    ...
    FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_TOP: [
    ...
    FullRegionName.KIIRUBERG_CLIFFS_TOP: [
    ...
    FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT: [
    ...
    FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT: [
    ...
    FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_RIGHT: [
    ...
    FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM: [
    ...
    FullRegionName.KIIRUBERG_SKI_LODGE: [
    ...
    # Mountain top
    FullRegionName.MOUNTAIN_TOP_BUS_STOP: [
    ...
    FullRegionName.BASTO_BUS_STOP_TOP: [
        Connection(FullRegionName.BASTO_BUS_STOP_BOTTOM, "Basto harbor gate from top", ERGroups.EXCLUDED, (ItemName.WATERGUN,)),
        Connection(FullRegionName.BASTO_LILY_PAD_POND_LEFT, "Basto harbor up", ERGroups.BASTO),
    ],
    FullRegionName.BASTO_BUS_STOP_BOTTOM: [
        Connection(FullRegionName.BASTO_BUS_STOP_TOP, "Basto harbor gate from bottom", ERGroups.EXCLUDED, (ItemName.WATERGUN,)),
        Connection(FullRegionName.STANHAMN_DOCKS_LEFT, "Viking express Basto stop", ERGroups.EXCLUDED, (ItemName.BASTO_TICKET,)),
    ],
    FullRegionName.BASTO_LILY_PAD_POND_LEFT: [
        Connection(FullRegionName.BASTO_BUS_STOP_TOP, "Lily pad pond down", ERGroups.BASTO),
        Connection(FullRegionName.BASTO_CAMP, "Lily pad pond left", ERGroups.BASTO),
        Connection(FullRegionName.BASTO_LILY_PAD_POND_RIGHT, "Lily pad pond night bridge from left", ERGroups.EXCLUDED, (EventName.BASTO_LILY_PAD_POND_LEFT_NIGHT,)),
    ],
    FullRegionName.BASTO_LILY_PAD_POND_RIGHT: [
        ...
        Connection(FullRegionName.BASTO_LILY_PAD_POND_LEFT, "Lily pad pond night bridge from right", ERGroups.EXCLUDED),
    ],
    FullRegionName.BASTO_CAMP: [
        Connection(FullRegionName.BASTO_TENT, "Tent entrance", ERGroups.BASTO),
        Connection(FullRegionName.BASTO_LILY_PAD_POND_LEFT, "Campsite right", ERGroups.BASTO),
    ],
    FullRegionName.BASTO_TENT: [
    ...
    FullRegionName.BASTO_BONFIRE_TOP: [
        ...
        Connection(FullRegionName.BASTO_BONFIRE_BOTTOM, "Bonfire day bridge from top", ERGroups.EXCLUDED),
    ],
    FullRegionName.BASTO_BONFIRE_BOTTOM: [
        Connection(FullRegionName.BASTO_CARNIVAL, "Carnival entrance", ERGroups.BASTO),
        Connection(FullRegionName.BASTO_BONFIRE_TOP, "Bonfire day bridge from bottom", ERGroups.EXCLUDED, (EventName.BASTO_BONFIRE_BOTTOM_DAY,)),
    ],
    FullRegionName.BASTO_CARNIVAL: [
        Connection(FullRegionName.BASTO_BONFIRE_BOTTOM, "Carnival exit", ERGroups.BASTO),
    ],
    ...
    FullRegionName.BASTO_CAVE: [
        Connection(FullRegionName.BASTO_SECRET_CAVE, "Secret cave room entrance", ERGroups.BASTO, (ItemName.PICKAXE, ItemName.WATERGUN)),
    ...
    FullRegionName.BASTO_SECRET_CAVE: [
