...
region_connections: list[Connection] = [
    # Menu
    Connection(FullRegionName.START_MENU, FullRegionName.HOMELANDA_PLAYER_ROOM,
               ConnectionName.START_GAME, ERGroups.EXCLUDED),

    # Homelanda
    Connection(FullRegionName.HOMELANDA_PLAYER_ROOM, FullRegionName.HOMELANDA_LIVING_ROOM,
               ConnectionName.PLAYER_ROOM_EXIT, ERGroups.HOMELANDA),
    Connection(FullRegionName.HOMELANDA_LIVING_ROOM, FullRegionName.HOMELANDA_PLAYER_ROOM,
               ConnectionName.PLAYER_ROOM_ENTRANCE, ERGroups.HOMELANDA),
    Connection(FullRegionName.HOMELANDA_LIVING_ROOM, FullRegionName.HOMELANDA_BUS_STOP,
               ConnectionName.HOMELANDA_HOUSE_EXIT, ERGroups.HOMELANDA),
    Connection(FullRegionName.HOMELANDA_BUS_STOP, FullRegionName.HOMELANDA_LIVING_ROOM,
               ConnectionName.HOMELANDA_HOUSE_ENTRANCE, ERGroups.HOMELANDA),
    Connection(FullRegionName.HOMELANDA_BUS_STOP, FullRegionName.OAKLAVILLE_BUS_STOP,
               ConnectionName.OAKLAVILLE_BUS_STOP, ERGroups.EXCLUDED, get_stamp_rule(RegionName.HOMELANDA)),

    # Oaklaville
    Connection(FullRegionName.OAKLAVILLE_BUS_STOP, FullRegionName.STANHAMN_BUS_STOP,
               ConnectionName.STANHAMN_BUS_STOP, ERGroups.EXCLUDED, get_stamp_rule(RegionName.OAKLAVILLE)),
    Connection(FullRegionName.OAKLAVILLE_BUS_STOP, FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL,
               ConnectionName.OAKLAVILLE_BUS_STOP_EXIT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL, FullRegionName.OAKLAVILLE_BUS_STOP,
               ConnectionName.OUTSIDE_HOTEL_DOWN, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL, FullRegionName.OAKLAVILLE_GHOST_CUP_GAME,
               ConnectionName.OUTSIDE_HOTEL_LEFT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL, FullRegionName.OAKLAVILLE_CAMP,
               ConnectionName.OUTSIDE_HOTEL_RIGHT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL, FullRegionName.OAKLAVILLE_HOTEL,
               ConnectionName.HOTEL_ENTRANCE, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_HOTEL, FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL,
               ConnectionName.HOTEL_EXIT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_HOTEL, FullRegionName.OAKLAVILLE_HOTEL_ELEVATOR,
               ConnectionName.HOTEL_ELEVATOR_ENTRANCE, ERGroups.OAKLAVILLE,
               CanReachLocation(LocationName.QUEST_HOTEL_CHEF)),
    Connection(FullRegionName.OAKLAVILLE_HOTEL_ELEVATOR, FullRegionName.OAKLAVILLE_HOTEL,
               ConnectionName.HOTEL_ELEVATOR_EXIT, ERGroups.OAKLAVILLE,
               CanReachLocation(LocationName.QUEST_HOTEL_CHEF)),
    Connection(FullRegionName.OAKLAVILLE_GHOST_CUP_GAME, FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL,
               ConnectionName.GHOST_CUP_GAME_RIGHT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_GHOST_CUP_GAME, FullRegionName.OAKLAVILLE_MUSHROOM_HOUSE,
               ConnectionName.MUSHROOM_HOUSE_ENTRANCE, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_GHOST_CUP_GAME, FullRegionName.OAKLAVILLE_HIDE_AND_SEEK,
               ConnectionName.GHOST_CUP_GAME_LEFT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_MUSHROOM_HOUSE, FullRegionName.OAKLAVILLE_GHOST_CUP_GAME,
               ConnectionName.MUSHROOM_HOUSE_EXIT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_HIDE_AND_SEEK, FullRegionName.OAKLAVILLE_GHOST_CUP_GAME,
               ConnectionName.HIDE_AND_SEEK_RIGHT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_HIDE_AND_SEEK, FullRegionName.OAKLAVILLE_GRAVEYARD,
               ConnectionName.HIDE_AND_SEEK_LEFT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_GRAVEYARD, FullRegionName.OAKLAVILLE_HIDE_AND_SEEK,
               ConnectionName.GRAVEYARD_RIGHT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_GRAVEYARD, FullRegionName.OAKLAVILLE_SKELETON_HOUSE,
               ConnectionName.SKELETON_HOUSE_ENTRANCE, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_SKELETON_HOUSE, FullRegionName.OAKLAVILLE_GRAVEYARD,
               ConnectionName.SKELETON_HOUSE_EXIT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_SKELETON_HOUSE, FullRegionName.OAKLAVILLE_SKELETON_BALCONY,
               ConnectionName.SKELETON_HOUSE_BALCONY_EXIT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_SKELETON_BALCONY, FullRegionName.OAKLAVILLE_SKELETON_HOUSE,
               ConnectionName.SKELETON_HOUSE_BALCONY_ENTRANCE, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_CAMP, FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL,
               ConnectionName.SCOUT_CAMP_LEFT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_CAMP, FullRegionName.OAKLAVILLE_TRAIL_BOTTOM,
               ConnectionName.SCOUT_CAMP_UP, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_CAMP, FullRegionName.OAKLAVILLE_PLAYGROUND,
               ConnectionName.SCOUT_CAMP_RIGHT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_TRAIL_TOP, FullRegionName.OAKLAVILLE_TRAIL_BOTTOM,
               ConnectionName.OAKLAVILLE_TRAIL_LOG_FROM_TOP, ERGroups.EXCLUDED,
               CanReachLocation(LocationName.QUEST_LOG_JAM)),
    Connection(FullRegionName.OAKLAVILLE_TRAIL_TOP, FullRegionName.OAKLAVILLE_LOOKOUT,
               ConnectionName.OAKLAVILLE_TRAIL_UP, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_TRAIL_BOTTOM, FullRegionName.OAKLAVILLE_TRAIL_TOP,
               ConnectionName.OAKLAVILLE_TRAIL_LOG_FROM_BOTTOM, ERGroups.EXCLUDED,
               CanReachLocation(LocationName.QUEST_LOG_JAM)),
    Connection(FullRegionName.OAKLAVILLE_TRAIL_BOTTOM, FullRegionName.OAKLAVILLE_CAMP,
               ConnectionName.OAKLAVILLE_TRAIL_DOWN, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_LOOKOUT, FullRegionName.OAKLAVILLE_TRAIL_TOP,
               ConnectionName.LOOKOUT_EXIT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_PLAYGROUND, FullRegionName.OAKLAVILLE_CAMP,
               ConnectionName.PLAYGROUND_LEFT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_PLAYGROUND, FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_BOTTOM,
               ConnectionName.PLAYGROUND_RIGHT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_TOP, FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_BOTTOM,
               ConnectionName.RAVE_BOUNCER_FROM_TOP, ERGroups.EXCLUDED,
               Has(ItemName.GHOST_GLASSES) & CanReachRegion(FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_BOTTOM)),
    Connection(FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_TOP, FullRegionName.OAKLAVILLE_RAVE,
               ConnectionName.RAVE_ENTRANCE, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_BOTTOM, FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_TOP,
               ConnectionName.RAVE_BOUNCER_FROM_BOTTOM, ERGroups.EXCLUDED, Has(ItemName.GHOST_GLASSES)),
    Connection(FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_BOTTOM, FullRegionName.OAKLAVILLE_PLAYGROUND,
               ConnectionName.OUTSIDE_RAVE_LEFT, ERGroups.OAKLAVILLE),
    Connection(FullRegionName.OAKLAVILLE_RAVE, FullRegionName.OAKLAVILLE_OUTSIDE_RAVE_TOP,
               ConnectionName.RAVE_EXIT, ERGroups.OAKLAVILLE),

    # Stanhamn
    Connection(FullRegionName.STANHAMN_BUS_STOP, FullRegionName.LOGCITY_BUS_STOP,
               ConnectionName.LOGCITY_BUS_STOP, ERGroups.EXCLUDED, get_stamp_rule(RegionName.STANHAMN)),
    Connection(FullRegionName.STANHAMN_BUS_STOP, FullRegionName.STANHAMN_PHOTO_GUILD_HUT,
               ConnectionName.PHOTO_GUILD_HUT_ENTRANCE, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_BUS_STOP, FullRegionName.STANHAMN_PIRATE_DRAWBRIDGE,
               ConnectionName.STANHAMN_BUS_STOP_LEFT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_BUS_STOP, FullRegionName.STANHAMN_DOCKS_LEFT,
               ConnectionName.STANHAMN_BUS_STOP_RIGHT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_BUS_STOP, FullRegionName.STANHAMN_OUTSIDE_HYDROPLANT,
               ConnectionName.RAFT_UP, ERGroups.STANHAMN,
               Has(ItemName.HONK_ATTACHMENT) | CanReachLocation(LocationName.QUEST_POWER)),
    Connection(FullRegionName.STANHAMN_PHOTO_GUILD_HUT, FullRegionName.STANHAMN_BUS_STOP,
               ConnectionName.PHOTO_GUILD_HUT_EXIT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_PIRATE_DRAWBRIDGE, FullRegionName.STANHAMN_BUS_STOP,
               ConnectionName.PIRATE_DRAWBRIDGE_RIGHT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_PIRATE_DRAWBRIDGE, FullRegionName.STANHAMN_HIPPO_BEACH,
               ConnectionName.PIRATE_DRAWBRIDGE_LEFT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_HIPPO_BEACH, FullRegionName.STANHAMN_PIRATE_DRAWBRIDGE,
               ConnectionName.HIPPO_BEACH_RIGHT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_HIPPO_BEACH, FullRegionName.STANHAMN_UNDERWATER,
               ConnectionName.HIPPO_BEACH_MANHOLE, ERGroups.STANHAMN,
               HasAll(ItemName.HONK_ATTACHMENT, ItemName.DIVING_HELMET)),
    Connection(FullRegionName.STANHAMN_HIPPO_BEACH, FullRegionName.STANHAMN_OUTSIDE_LIGHTHOUSE,
               ConnectionName.HIPPO_BEACH_LEFT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_UNDERWATER, FullRegionName.STANHAMN_HIPPO_BEACH,
               ConnectionName.UNDERWATER_EXIT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_OUTSIDE_LIGHTHOUSE, FullRegionName.STANHAMN_HIPPO_BEACH,
               ConnectionName.OUTSIDE_LIGHTHOUSE_RIGHT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_OUTSIDE_LIGHTHOUSE, FullRegionName.STANHAMN_KING_FISH_BEACH,
               ConnectionName.OUTSIDE_LIGHTHOUSE_UP, ERGroups.STANHAMN, Has(ItemName.HONK_ATTACHMENT)),
    Connection(FullRegionName.STANHAMN_OUTSIDE_LIGHTHOUSE, FullRegionName.STANHAMN_LIGHTHOUSE,
               ConnectionName.LIGHTHOUSE_ENTRANCE, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_LIGHTHOUSE, FullRegionName.STANHAMN_OUTSIDE_LIGHTHOUSE,
               ConnectionName.LIGHTHOUSE_EXIT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_LIGHTHOUSE, FullRegionName.STANHAMN_LIGHTHOUSE_ROOF,
               ConnectionName.LIGHTHOUSE_ROOF_ENTRANCE, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_LIGHTHOUSE_ROOF, FullRegionName.STANHAMN_LIGHTHOUSE,
               ConnectionName.LIGHTHOUSE_ROOF_EXIT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_KING_FISH_BEACH, FullRegionName.STANHAMN_OUTSIDE_LIGHTHOUSE,
               ConnectionName.KING_FISH_BEACH_EXIT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_DOCKS_LEFT, FullRegionName.STANHAMN_BUS_STOP,
               ConnectionName.DOCKS_LEFT_EXIT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_DOCKS_LEFT, FullRegionName.BASTO_BUS_STOP_BOTTOM,
               ConnectionName.VIKING_EXPRESS_STAMHAMN_STOP, ERGroups.EXCLUDED, Has(ItemName.BASTO_TICKET)),
    Connection(FullRegionName.STANHAMN_DOCKS_LEFT, FullRegionName.STANHAMN_DOCKS_RIGHT,
               ConnectionName.DOCKS_DRAWBRIDGE_FROM_LEFT, ERGroups.EXCLUDED,
               CanReachLocation(LocationName.QUEST_POWER)),
    Connection(FullRegionName.STANHAMN_DOCKS_RIGHT, FullRegionName.STANHAMN_FISHING_TOWER,
               ConnectionName.DOCKS_RIGHT_EXIT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_DOCKS_RIGHT, FullRegionName.STANHAMN_DOCKS_LEFT,
               ConnectionName.DOCKS_DRAWBRIDGE_FROM_RIGHT, ERGroups.EXCLUDED,
               CanReachLocation(LocationName.QUEST_POWER)),
    Connection(FullRegionName.STANHAMN_FISHING_TOWER, FullRegionName.STANHAMN_DOCKS_RIGHT,
               ConnectionName.FISHING_TOWER_LEFT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_FISHING_TOWER, FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_BOTTOM,
               ConnectionName.FISHING_TOWER_UP, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_TOP, FullRegionName.STANHAMN_OUTSIDE_HYDROPLANT,
               ConnectionName.GHOST_DRAWBRIDGE_LEFT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_TOP, FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_BOTTOM,
               ConnectionName.GHOST_DRAWBRIDGE_FROM_TOP, ERGroups.EXCLUDED, CanReachLocation(LocationName.QUEST_POWER)),
    Connection(FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_BOTTOM, FullRegionName.STANHAMN_FISHING_TOWER,
               ConnectionName.GHOST_DRAWBRIDGE_DOWN, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_BOTTOM, FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_TOP,
               ConnectionName.GHOST_DRAWBRIDGE_FROM_BOTTOM, ERGroups.EXCLUDED,
               CanReachLocation(LocationName.QUEST_POWER)),
    Connection(FullRegionName.STANHAMN_OUTSIDE_HYDROPLANT, FullRegionName.STANHAMN_BUS_STOP,
               ConnectionName.RAFT_DOWN, ERGroups.STANHAMN,
               Has(ItemName.HONK_ATTACHMENT) | CanReachLocation(LocationName.QUEST_POWER)),
    Connection(FullRegionName.STANHAMN_OUTSIDE_HYDROPLANT, FullRegionName.STANHAMN_HYDROPLANT,
               ConnectionName.HYDROPLANT_ENTRANCE, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_OUTSIDE_HYDROPLANT, FullRegionName.STANHAMN_GHOST_DRAWBRIDGE_TOP,
               ConnectionName.OUTSIDE_HYDROPLANT_RIGHT, ERGroups.STANHAMN),
    Connection(FullRegionName.STANHAMN_HYDROPLANT, FullRegionName.STANHAMN_OUTSIDE_HYDROPLANT,
               ConnectionName.HYDROPLANT_EXIT, ERGroups.STANHAMN),

    # Logcity
    Connection(FullRegionName.LOGCITY_BUS_STOP, FullRegionName.KIIRUBERG_BUS_STOP,
               ConnectionName.KIIRUBERG_BUS_STOP, ERGroups.EXCLUDED, get_stamp_rule(RegionName.LOGCITY)),
    Connection(FullRegionName.LOGCITY_BUS_STOP, FullRegionName.LOGCITY_CLOCK_TOWER,
               ConnectionName.ESCALATOR_UP, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_CLOCK_TOWER, FullRegionName.LOGCITY_BUS_STOP,
               ConnectionName.LOGCITY_BUS_STOP_ENTRANCE, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_CLOCK_TOWER, FullRegionName.LOGCITY_CROSSWALK,
               ConnectionName.CLOCK_TOWER_LEFT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_CLOCK_TOWER, FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW,
               ConnectionName.CLOCK_TOWER_UP, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_CLOCK_TOWER, FullRegionName.LOGCITY_OUTSIDE_CAFE,
               ConnectionName.CLOCK_TOWER_RIGHT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_CROSSWALK, FullRegionName.LOGCITY_CLOCK_TOWER,
               ConnectionName.CROSS_WALK_RIGHT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_CROSSWALK, FullRegionName.LOGCITY_OVERPASS,
               ConnectionName.CROSS_WALK_UP, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OVERPASS, FullRegionName.LOGCITY_CROSSWALK,
               ConnectionName.OVERPASS_DOWN, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OVERPASS, FullRegionName.LOGCITY_NEWS_HOUSE,
               ConnectionName.NEWS_HOUSE_ENTRANCE, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OVERPASS, FullRegionName.LOGCITY_SKATE_PARK,
               ConnectionName.OVERPASS_UP, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OVERPASS, FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW,
               ConnectionName.OVERPASS_RIGHT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_NEWS_HOUSE, FullRegionName.LOGCITY_OVERPASS,
               ConnectionName.NEWS_HOUSE_EXIT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_SKATE_PARK, FullRegionName.LOGCITY_OVERPASS,
               ConnectionName.SKATE_PARK_DOWN, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_SKATE_PARK, FullRegionName.LOGCITY_RATSKULLZ_ALLEY,
               ConnectionName.SKATE_PARK_RIGHT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_SKATE_PARK, FullRegionName.LOGCITY_OUTSIDE_CAFE,
               ConnectionName.SKATE_PARK_TAXI, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_RATSKULLZ_ALLEY, FullRegionName.LOGCITY_SKATE_PARK,
               ConnectionName.RATSKULLZ_ALLEY_EXIT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW, FullRegionName.LOGCITY_FASHION_SHOW_BOTTOM,
               ConnectionName.FASHION_SHOW_ENTRANCE, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW, FullRegionName.LOGCITY_CLOCK_TOWER,
               ConnectionName.OUTSIDE_FASHION_SHOW_DOWN, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW, FullRegionName.LOGCITY_OVERPASS,
               ConnectionName.OUTSIDE_FASHION_SHOW_LEFT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW, FullRegionName.LOGCITY_OUTSIDE_GALLERY,
               ConnectionName.OUTSIDE_FASHION_SHOW_RIGHT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_FASHION_SHOW_TOP, FullRegionName.LOGCITY_FASHION_SHOW_BOTTOM,
               ConnectionName.FASHION_SHOW_SECURITY_FROM_TOP, ERGroups.EXCLUDED,
               Has(ItemName.REPORTER_HAT) & CanReachRegion(FullRegionName.LOGCITY_FASHION_SHOW_BOTTOM)),
    Connection(FullRegionName.LOGCITY_FASHION_SHOW_TOP, FullRegionName.LOGCITY_FASHION_SHOW_BACKSTAGE,
               ConnectionName.FASHION_SHOW_BACKSTAGE_ENTRANCE, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_FASHION_SHOW_BOTTOM, FullRegionName.LOGCITY_FASHION_SHOW_TOP,
               ConnectionName.FASHION_SHOW_SECURITY_FROM_BOTTOM, ERGroups.EXCLUDED, Has(ItemName.REPORTER_HAT)),
    Connection(FullRegionName.LOGCITY_FASHION_SHOW_BOTTOM, FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW,
               ConnectionName.FASHION_SHOW_EXIT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_FASHION_SHOW_BACKSTAGE, FullRegionName.LOGCITY_FASHION_SHOW_TOP,
               ConnectionName.FASHION_SHOW_BACKSTAGE_EXIT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_CAFE, FullRegionName.LOGCITY_CAFE,
               ConnectionName.CAFE_ENTRANCE, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_CAFE, FullRegionName.LOGCITY_CLOCK_TOWER,
               ConnectionName.OUTSIDE_CAFE_LEFT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_CAFE, FullRegionName.LOGCITY_OUTSIDE_GALLERY,
               ConnectionName.OUTSIDE_CAFE_UP, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_CAFE, FullRegionName.LOGCITY_SKATE_PARK,
               ConnectionName.OUTSIDE_CAFE_TAXI, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_CAFE, FullRegionName.LOGCITY_OUTSIDE_CAFE,
               ConnectionName.CAFE_EXIT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_GALLERY, FullRegionName.LOGCITY_GALLERY,
               ConnectionName.GALLERY_ENTRANCE, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_GALLERY, FullRegionName.LOGCITY_OUTSIDE_CAFE,
               ConnectionName.OUTSIDE_GALLERY_SHOW_DOWN, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_OUTSIDE_GALLERY, FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW,
               ConnectionName.OUTSIDE_GALLERY_SHOW_LEFT, ERGroups.LOGCITY),
    Connection(FullRegionName.LOGCITY_GALLERY, FullRegionName.LOGCITY_OUTSIDE_GALLERY,
               ConnectionName.GALLERY_EXIT, ERGroups.LOGCITY),

    # Kiiruberg
    Connection(FullRegionName.KIIRUBERG_BUS_STOP, FullRegionName.MOUNTAIN_TOP_BUS_STOP,
               ConnectionName.MOUNTAIN_TOP_BUS_STOP, ERGroups.EXCLUDED, get_stamp_rule(RegionName.KIIRUBERG)),
    Connection(FullRegionName.KIIRUBERG_BUS_STOP, FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM,
               ConnectionName.KIIRUBERG_BUS_STOP_UP, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM, FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_TOP,
               ConnectionName.BIRTHDAY_PARTY_ROPE_FROM_BOTTOM, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM, FullRegionName.KIIRUBERG_BALLOON_HOUSE,
               ConnectionName.BALLOON_HOUSE_ENTRANCE, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM, FullRegionName.KIIRUBERG_BUS_STOP,
               ConnectionName.BIRTHDAY_PARTY_DOWN, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM, FullRegionName.KIIRUBERG_FROZEN_POND,
               ConnectionName.BIRTHDAY_PARTY_LEFT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM, FullRegionName.KIIRUBERG_SKI_LIFT_BASE,
               ConnectionName.BIRTHDAY_PARTY_RIGHT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_TOP, FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM,
               ConnectionName.BIRTHDAY_PARTY_ROPE_FROM_TOP, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_TOP, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM,
               ConnectionName.BIRTHDAY_PARTY_UP, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_BALLOON_HOUSE, FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM,
               ConnectionName.BALLOON_HOUSE_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_FROZEN_POND, FullRegionName.KIIRUBERG_OLD_MANS_HOUSE,
               ConnectionName.OLD_MANS_HOUSE_ENTRANCE, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_FROZEN_POND, FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM,
               ConnectionName.FROZEN_POND_RIGHT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_OLD_MANS_HOUSE, FullRegionName.KIIRUBERG_FROZEN_POND,
               ConnectionName.OLD_MANS_HOUSE_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_TOP,
               ConnectionName.SNOWMAN_SQUARE_ROPE_FROM_BOTTOM, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM, FullRegionName.KIIRUBERG_MILITARY_BASE,
               ConnectionName.MILITARY_BASE_ENTRANCE, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM, FullRegionName.KIIRUBERG_MECKS_HOUSE,
               ConnectionName.MECKS_HOUSE_ENTRANCE, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM, FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_TOP,
               ConnectionName.SNOWMAN_SQUARE_DOWN, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_TOP, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM,
               ConnectionName.SNOWMAN_SQUARE_ROPE_FROM_TOP, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_TOP, FullRegionName.KIIRUBERG_OUTSIDE_WIZARD_TOWER,
               ConnectionName.SNOWMAN_SQUARE_LEFT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_TOP, FullRegionName.KIIRUBERG_CLIFFS_BOTTOM,
               ConnectionName.SNOWMAN_SQUARE_UP, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_MILITARY_BASE, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM,
               ConnectionName.MILITARY_BASE_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_MECKS_HOUSE, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_BOTTOM,
               ConnectionName.MECKS_HOUSE_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_OUTSIDE_WIZARD_TOWER, FullRegionName.KIIRUBERG_WIZARD_TOWER,
               ConnectionName.WIZARD_TOWER_ENTRANCE, ERGroups.KIIRUBERG, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_OUTSIDE_WIZARD_TOWER, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_TOP,
               ConnectionName.OUTSIDE_WIZARD_TOWER_RIGHT, ERGroups.KIIRUBERG, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_WIZARD_TOWER, FullRegionName.KIIRUBERG_COSMO_GARDEN,
               ConnectionName.WIZARD_PORTAL_ENTRANCE, ERGroups.KIIRUBERG,
               CanReachLocation(LocationName.QUEST_ICE_WIZARD)),
    Connection(FullRegionName.KIIRUBERG_WIZARD_TOWER, FullRegionName.KIIRUBERG_OUTSIDE_WIZARD_TOWER,
               ConnectionName.WIZARD_TOWER_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_COSMO_GARDEN, FullRegionName.KIIRUBERG_WIZARD_TOWER,
               ConnectionName.WIZARD_PORTAL_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_CLIFFS_BOTTOM, FullRegionName.KIIRUBERG_SNOWMAN_SQUARE_TOP,
               ConnectionName.CLIFFS_DOWN, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_CLIFFS_BOTTOM, FullRegionName.KIIRUBERG_CLIFFS_MIDDLE,
               ConnectionName.CLIFFS_BOTTOM_ROPE_FROM_BOTTOM, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_CLIFFS_MIDDLE, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT,
               ConnectionName.CLIFFS_RIGHT, ERGroups.KIIRUBERG, Has(ItemName.HONK_ATTACHMENT)),
    Connection(FullRegionName.KIIRUBERG_CLIFFS_MIDDLE, FullRegionName.KIIRUBERG_CLIFFS_BOTTOM,
               ConnectionName.CLIFFS_BOTTOM_ROPE_FROM_MIDDLE, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_CLIFFS_MIDDLE, FullRegionName.KIIRUBERG_CLIFFS_TOP,
               ConnectionName.CLIFFS_TOP_ROPE_FROM_MIDDLE, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_CLIFFS_TOP, FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM,
               ConnectionName.CLIFFS_UP, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_CLIFFS_TOP, FullRegionName.KIIRUBERG_CLIFFS_MIDDLE,
               ConnectionName.CLIFFS_TOP_ROPE_FROM_TOP, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT, FullRegionName.KIIRUBERG_CLIFFS_MIDDLE,
               ConnectionName.BLIZZARD_BRIDGE_LEFT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_RIGHT,
    ...
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT,
    ...
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT, FullRegionName.KIIRUBERG_MAN_CAVE,
               ConnectionName.MAN_CAVE_ENTRANCE, ERGroups.KIIRUBERG,
               CanReachLocation(LocationName.QUEST_EXPERIENCE_TOEM)),
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_RIGHT,
               ConnectionName.BLIZZARD_BRIDGE_ROPE_FROM_UPPER_LEFT, ERGroups.EXCLUDED,
               HasAll(ItemName.CLIMBING_BOOTS, ItemName.PUFFER_HAT, ItemName.SCARF, ItemName.SKI_GOGGLES)),
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT,
               ConnectionName.BLIZZARD_BRIDGE_BREAK_ICE_FROM_TOP, ERGroups.EXCLUDED, Has(ItemName.HONK_ATTACHMENT)),
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_RIGHT, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_LOWER_LEFT,
               ConnectionName.BLIZZARD_BRIDGE_ROPE_FROM_LOWER_RIGHT, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_RIGHT, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT,
               ConnectionName.BLIZZARD_BRIDGE_ROPE_FROM_UPPER_RIGHT, ERGroups.EXCLUDED,
               HasAll(ItemName.CLIMBING_BOOTS, ItemName.PUFFER_HAT, ItemName.SCARF, ItemName.SKI_GOGGLES)),
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_RIGHT, FullRegionName.KIIRUBERG_BLIZZARD_MONSTER,
               ConnectionName.BLIZZARD_BRIDGE_RIGHT, ERGroups.KIIRUBERG, Has(ItemName.HONK_ATTACHMENT)),
    Connection(FullRegionName.KIIRUBERG_MAN_CAVE, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_UPPER_LEFT,
               ConnectionName.MAN_CAVE_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_BLIZZARD_MONSTER, FullRegionName.KIIRUBERG_BLIZZARD_BRIDGE_RIGHT,
               ConnectionName.BLIZZARD_MONSTER_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_TOP, FullRegionName.KIIRUBERG_OBSERVATORY,
               ConnectionName.OBSERVATORY_ENTRANCE, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_TOP, FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM,
               ConnectionName.OUTSIDE_OBSERVATORY_ROPE_FROM_TOP, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM, FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_TOP,
               ConnectionName.OUTSIDE_OBSERVATORY_ROPE_FROM_BOTTOM, ERGroups.EXCLUDED, Has(ItemName.CLIMBING_BOOTS)),
    Connection(FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM, FullRegionName.KIIRUBERG_CLIFFS_TOP,
               ConnectionName.OUTSIDE_OBSERVATORY_DOWN, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM, FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP,
               ConnectionName.OUTSIDE_OBSERVATORY_RIGHT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_OBSERVATORY, FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_TOP,
               ConnectionName.OBSERVATORY_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SKI_LIFT_BASE, FullRegionName.KIIRUBERG_SKI_LODGE,
               ConnectionName.SKI_LODGE_ENTRANCE, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SKI_LIFT_BASE, FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM,
               ConnectionName.SKI_LIFT_BASE_LEFT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SKI_LIFT_BASE, FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP,
               ConnectionName.SKI_LIFT_UP, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SKI_LODGE, FullRegionName.KIIRUBERG_SKI_LIFT_BASE,
               ConnectionName.SKI_LODGE_EXIT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP, FullRegionName.KIIRUBERG_OUTSIDE_OBSERVATORY_BOTTOM,
               ConnectionName.SKI_MOUNTAIN_TOP_LEFT, ERGroups.KIIRUBERG),
    Connection(FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP, FullRegionName.KIIRUBERG_SKI_LIFT_BASE,
    ...
    Connection(FullRegionName.BASTO_BUS_STOP_TOP, FullRegionName.BASTO_LILY_PAD_POND_LEFT,
               ConnectionName.BASTO_HARBOR_UP, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_BUS_STOP_BOTTOM, FullRegionName.BASTO_BUS_STOP_TOP,
               ConnectionName.BASTO_HARBOR_GATE_FROM_BOTTOM, ERGroups.EXCLUDED, Has(ItemName.WATERGUN)),
    Connection(FullRegionName.BASTO_BUS_STOP_BOTTOM, FullRegionName.STANHAMN_DOCKS_LEFT,
               ConnectionName.VIKING_EXPRESS_BASTO_STOP, ERGroups.EXCLUDED, Has(ItemName.BASTO_TICKET)),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_LEFT, FullRegionName.BASTO_BUS_STOP_TOP,
               ConnectionName.LILY_PAD_POND_DOWN, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_LEFT, FullRegionName.BASTO_CAMP,
               ConnectionName.LILY_PAD_POND_LEFT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_LEFT, FullRegionName.BASTO_LILY_PAD_POND_RIGHT,
               ConnectionName.LILY_PAD_POND_NIGHT_BRIDGE_FROM_LEFT, ERGroups.EXCLUDED,
               Has(EventName.BASTO_LILY_PAD_POND_LEFT_NIGHT)),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_RIGHT, FullRegionName.BASTO_GHOST_HANGOUT,
               ConnectionName.LILY_PAD_POND_RIGHT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_RIGHT, FullRegionName.BASTO_OUTSIDE_CASTLE,
               ConnectionName.LILY_PAD_POND_UP, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_RIGHT, FullRegionName.BASTO_LILY_PAD_POND_LEFT,
               ConnectionName.LILY_PAD_POND_NIGHT_BRIDGE_FROM_RIGHT, ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_CAMP, FullRegionName.BASTO_TENT,
               ConnectionName.TENT_ENTRANCE, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_CAMP, FullRegionName.BASTO_LILY_PAD_POND_LEFT,
               ConnectionName.CAMPSITE_RIGHT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_TENT, FullRegionName.BASTO_CAMP,
               ConnectionName.TENT_EXIT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_OUTSIDE_CASTLE, FullRegionName.BASTO_CASTLE,
               ConnectionName.CASTLE_ENTRANCE, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_OUTSIDE_CASTLE, FullRegionName.BASTO_GYM_HOUSE,
               ConnectionName.GYM_HOUSE_ENTRANCE, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_OUTSIDE_CASTLE, FullRegionName.BASTO_LILY_PAD_POND_RIGHT,
               ConnectionName.OUTSIDE_CASTLE_DOWN, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_OUTSIDE_CASTLE, FullRegionName.BASTO_BONFIRE_TOP,
               ConnectionName.OUTSIDE_CASTLE_LEFT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_CASTLE, FullRegionName.BASTO_OUTSIDE_CASTLE,
               ConnectionName.CASTLE_EXIT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_GYM_HOUSE, FullRegionName.BASTO_OUTSIDE_CASTLE,
               ConnectionName.GYM_HOUSE_EXIT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_BONFIRE_TOP, FullRegionName.BASTO_OUTSIDE_CASTLE,
               ConnectionName.BONFIRE_LOWER_RIGHT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_BONFIRE_TOP, FullRegionName.BASTO_JUNGLE,
               ConnectionName.BONFIRE_UPPER_RIGHT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_BONFIRE_TOP, FullRegionName.BASTO_BONFIRE_BOTTOM,
               ConnectionName.BONFIRE_DAY_BRIDGE_FROM_TOP, ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_BONFIRE_BOTTOM, FullRegionName.BASTO_CARNIVAL,
               ConnectionName.CARNIVAL_ENTRANCE, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_BONFIRE_BOTTOM, FullRegionName.BASTO_BONFIRE_TOP,
               ConnectionName.BONFIRE_DAY_BRIDGE_FROM_BOTTOM, ERGroups.EXCLUDED,
               Has(EventName.BASTO_BONFIRE_BOTTOM_DAY)),
    Connection(FullRegionName.BASTO_CARNIVAL, FullRegionName.BASTO_BONFIRE_BOTTOM,
               ConnectionName.CARNIVAL_EXIT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_GHOST_HANGOUT, FullRegionName.BASTO_CAVE,
               ConnectionName.GHOST_HANGOUT_CAVE_ENTRANCE, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_GHOST_HANGOUT, FullRegionName.BASTO_LILY_PAD_POND_RIGHT,
               ConnectionName.GHOST_HANGOUT_LEFT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_CAVE, FullRegionName.BASTO_SECRET_CAVE,
               ConnectionName.SECRET_CAVE_ROOM_ENTRANCE, ERGroups.BASTO, HasAll(ItemName.PICKAXE, ItemName.WATERGUN)),
    Connection(FullRegionName.BASTO_CAVE, FullRegionName.BASTO_GHOST_HANGOUT,
               ConnectionName.GHOST_HANGOUT_CAVE_EXIT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_CAVE, FullRegionName.BASTO_JUNGLE,
               ConnectionName.JUNGLE_CAVE_EXIT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_SECRET_CAVE, FullRegionName.BASTO_CAVE,
               ConnectionName.SECRET_CAVE_ROOM_EXIT, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_JUNGLE, FullRegionName.BASTO_CAVE,
               ConnectionName.JUNGLE_CAVE_ENTRANCE, ERGroups.BASTO),
    Connection(FullRegionName.BASTO_JUNGLE, FullRegionName.BASTO_BONFIRE_TOP,
               ConnectionName.JUNGLE_LEFT, ERGroups.BASTO),

    # Helper connections
    # Super region connections
    *[Connection(region, FullRegionName.OAKLAVILLE,
                 f"{region} in {RegionName.OAKLAVILLE}", ERGroups.EXCLUDED) for region in oaklaville_regions],
    *[Connection(region, FullRegionName.STANHAMN,
                 f"{region} in {RegionName.STANHAMN}", ERGroups.EXCLUDED) for region in stanhamn_regions],
    *[Connection(region, FullRegionName.LOGCITY,
                 f"{region} in {RegionName.LOGCITY}", ERGroups.EXCLUDED) for region in logcity_regions],
    *[Connection(region, FullRegionName.KIIRUBERG,
                 f"{region} in {RegionName.KIIRUBERG}", ERGroups.EXCLUDED) for region in kiiruberg_regions],
    *[Connection(region, FullRegionName.MOUNTAIN_TOP,
                 f"{region} in {RegionName.MOUNTAIN_TOP}", ERGroups.EXCLUDED) for region in mountain_top_regions],
    *[Connection(region, FullRegionName.BASTO,
                 f"{region} in {RegionName.BASTO}", ERGroups.EXCLUDED) for region in basto_regions],
    # Compendium connections
    Connection(FullRegionName.OAKLAVILLE_GHOST_CUP_GAME, FullRegionName.SQUIRRELS,
               "Squirrel from Ghost cup game", ERGroups.EXCLUDED),
    Connection(FullRegionName.OAKLAVILLE_HOTEL_ELEVATOR, FullRegionName.SQUIRRELS,
               "Squirrels from Hotel elevator", ERGroups.EXCLUDED),
    Connection(FullRegionName.STANHAMN_BUS_STOP, FullRegionName.SEAGULLS,
               "Seagulls from Stanhamn bus stop", ERGroups.EXCLUDED),
    Connection(FullRegionName.STANHAMN_HIPPO_BEACH, FullRegionName.SEAGULLS,
               "Seagulls from Hippo beach", ERGroups.EXCLUDED),
    Connection(FullRegionName.STANHAMN_OUTSIDE_LIGHTHOUSE, FullRegionName.SEAGULLS,
               "Seagulls from Outside lighthouse", ERGroups.EXCLUDED),
    Connection(FullRegionName.STANHAMN_DOCKS_LEFT, FullRegionName.SUNDAY_SWAN,
               "Sunday swan from Docks left", ERGroups.EXCLUDED),
    Connection(FullRegionName.STANHAMN_DOCKS_RIGHT, FullRegionName.SUNDAY_SWAN,
               "Sunday swan from Docks right", ERGroups.EXCLUDED),
    Connection(FullRegionName.LOGCITY_CLOCK_TOWER, FullRegionName.PIGEON,
               "Pigeon from Clock tower", ERGroups.EXCLUDED),
    Connection(FullRegionName.LOGCITY_OUTSIDE_CAFE, FullRegionName.PIGEON,
               "Pigeon from Outside cafe", ERGroups.EXCLUDED),
    Connection(FullRegionName.LOGCITY_OUTSIDE_GALLERY, FullRegionName.PIGEON,
               "Pigeon from Outside gallery", ERGroups.EXCLUDED),
    Connection(FullRegionName.LOGCITY_RATSKULLZ_ALLEY, FullRegionName.PIGEON,
               "Pigeon from Ratskullz alley", ERGroups.EXCLUDED),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM, FullRegionName.GOAT,
               "Goat from Birthday party bottom", ERGroups.EXCLUDED),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_TOP, FullRegionName.GOAT,
               "Goat from Birthday party top", ERGroups.EXCLUDED),
    Connection(FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP, FullRegionName.GOAT,
               "Goat from Ski mountain top", ERGroups.EXCLUDED),
    Connection(FullRegionName.KIIRUBERG_CLIFFS_TOP, FullRegionName.GOAT,
               "Goat from Cliffs top", ERGroups.EXCLUDED),
    Connection(FullRegionName.KIIRUBERG_CLIFFS_MIDDLE, FullRegionName.GOAT,
               "Goat from Cliffs middle", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_CAVE, FullRegionName.BAT,
               "Bat from Cave", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_BONFIRE_TOP, FullRegionName.BAT,
               "Bat from Bonfire top", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_OUTSIDE_CASTLE, FullRegionName.BAT,
               "Bat from Outside castle", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_BUS_STOP_BOTTOM, FullRegionName.BEAK_BIRD,
               "Beak bird from Harbor bottom", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_BUS_STOP_TOP, FullRegionName.BEAK_BIRD,
               "Beak bird from Harbor top", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_LEFT, FullRegionName.BEAK_BIRD,
               "Beak bird from Lily pad pond left", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_RIGHT, FullRegionName.BEAK_BIRD,
               "Beak bird from Lily pad pond right", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_BUS_STOP_BOTTOM, FullRegionName.BITLING_TATO,
               "Bitling tato from Harbor bottom", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_BUS_STOP_TOP, FullRegionName.BITLING_TATO,
               "Bitling tato from Harbor top", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_LEFT, FullRegionName.WATER_STRIDER,
               "Water strider from Lily pad pond left", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_OUTSIDE_CASTLE, FullRegionName.WATER_STRIDER,
               "Water strider from Outside castle", ERGroups.EXCLUDED),
    # Achievement connections
    Connection(FullRegionName.OAKLAVILLE_OUTSIDE_HOTEL, FullRegionName.GOOD_BOY,
               "Pet Tom", ERGroups.EXCLUDED),
    Connection(FullRegionName.OAKLAVILLE_HOTEL, FullRegionName.GOOD_BOY,
               "Pet Oskar", ERGroups.EXCLUDED),
    Connection(FullRegionName.OAKLAVILLE_GRAVEYARD, FullRegionName.GOOD_BOY,
               "Pet Sero", ERGroups.EXCLUDED),
    Connection(FullRegionName.OAKLAVILLE_CAMP, FullRegionName.GOOD_BOY,
               "Pet the Pet rock", ERGroups.EXCLUDED),
    Connection(FullRegionName.STANHAMN_DOCKS_RIGHT, FullRegionName.GOOD_BOY,
               "Pet Fia", ERGroups.EXCLUDED),
    Connection(FullRegionName.STANHAMN_DOCKS_LEFT, FullRegionName.GOOD_BOY,
               "Pet Fräs", ERGroups.EXCLUDED),
    Connection(FullRegionName.STANHAMN_KING_FISH_BEACH, FullRegionName.GOOD_BOY,
               "Pet Willemijn", ERGroups.EXCLUDED),
    Connection(FullRegionName.LOGCITY_OUTSIDE_CAFE, FullRegionName.GOOD_BOY,
               "Pet Portillo", ERGroups.EXCLUDED),
    Connection(FullRegionName.KIIRUBERG_BALLOON_HOUSE, FullRegionName.GOOD_BOY,
               "Pet Mikée or Nariko", ERGroups.EXCLUDED),
    Connection(FullRegionName.KIIRUBERG_MECKS_HOUSE, FullRegionName.GOOD_BOY,
               "Pet Teddy", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_LILY_PAD_POND_LEFT, FullRegionName.MAXIMUM_VACATION,
               "Sit on a chair in Lily pad pond left", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_GYM_HOUSE, FullRegionName.MAXIMUM_VACATION,
               "Sit on a chair in Gym house", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_CARNIVAL, FullRegionName.MAXIMUM_VACATION,
               "Sit on a chair in Carnival", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_BONFIRE_TOP, FullRegionName.MAXIMUM_VACATION,
               "Sit on a chair in Bonfire top", ERGroups.EXCLUDED),
    Connection(FullRegionName.BASTO_GHOST_HANGOUT, FullRegionName.MAXIMUM_VACATION,
               "Sit on a chair in Ghost hangout", ERGroups.EXCLUDED),
    # Cassette connections
    Connection(FullRegionName.LOGCITY_BUS_STOP, FullRegionName.BIG_CITY_TAPE,
               "Visit Logicity bus stop", ERGroups.EXCLUDED),
    Connection(FullRegionName.LOGCITY_OUTSIDE_FASHION_SHOW, FullRegionName.BIG_CITY_TAPE,
               "Visit Outside fasion show", ERGroups.EXCLUDED),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_BOTTOM, FullRegionName.STORIES_OF_SNOW_TAPE,
               "Visit Birthday party bottom", ERGroups.EXCLUDED),
    Connection(FullRegionName.KIIRUBERG_BIRTHDAY_PARTY_TOP, FullRegionName.STORIES_OF_SNOW_TAPE,
