...
region_connections: list[Connection] = [
    ...
    Connection(FullRegionName.STANHAMN_BUS_STOP, FullRegionName.STANHAMN_OUTSIDE_HYDROPLANT, ConnectionName.RAFT_UP, ERGroups.EXCLUDED, ((ItemName.HONK_ATTACHMENT, LocationName.QUEST_POWER),)),
    ...
    Connection(FullRegionName.STANHAMN_OUTSIDE_HYDROPLANT, FullRegionName.STANHAMN_BUS_STOP, ConnectionName.RAFT_DOWN, ERGroups.EXCLUDED, ((ItemName.HONK_ATTACHMENT, LocationName.QUEST_POWER),)),
    ...
    Connection(FullRegionName.KIIRUBERG_SKI_LIFT_BASE, FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP, ConnectionName.SKI_LIFT_UP, ERGroups.EXCLUDED),
    ...
    Connection(FullRegionName.KIIRUBERG_SKI_MOUNTAIN_TOP, FullRegionName.KIIRUBERG_SKI_LIFT_BASE, ConnectionName.SKI_LIFT_DOWN, ERGroups.EXCLUDED),
    # Mountain top
