...
item_table: dict[str, ItemData] = {
    ...
    ItemName.TRIPOD: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.OAKLAVILLE),
    ItemName.COWBOY_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.OAKLAVILLE),
    ItemName.WET_SOCKS: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.OAKLAVILLE),
    ItemName.FJALLBJORN_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.OAKLAVILLE),
    ItemName.GHOST_GLASSES: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.OAKLAVILLE),
    ItemName.SOAKED_SOCK: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.OAKLAVILLE),
    ItemName.MONSTER_MASK: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.OAKLAVILLE),
    ItemName.FRAMES_FILTERS: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.FISHING_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.HONK_ATTACHMENT: ItemData(progression_useful, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.UMBRELLA: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.OLD_KEY: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.HARD_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.DIVING_HELMET: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.RUBBER_BOOTS: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.SANDWICH: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.PIRATE_HAT: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.PAPER_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.FLAG: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.STANHAMN),
    ItemName.HOTBEAN_HAT: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.LOGCITY),
    ItemName.REPORTER_HAT: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.LOGCITY),
    ItemName.SNEAKERS: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.LOGCITY),
    ItemName.CINNAMON_BUN: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.LOGCITY),
    ItemName.FRISBEE: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.LOGCITY),
    ItemName.CLIMBING_BOOTS: ItemData(progression_useful, 1, ItemGroup.ITEM, Area.KIIRUBERG),
    ItemName.PUFFER_HAT: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.KIIRUBERG),
    ItemName.SCARF: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.KIIRUBERG),
    ItemName.SKI_GOGGLES: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.KIIRUBERG),
    ItemName.SPACE_HELMET: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.KIIRUBERG),
    ItemName.BASTO_TICKET: ItemData(progression_useful, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.WATERGUN: ItemData(progression_useful, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.SUN_HAT: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.MELONEAR: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.BANAKIN: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.ORANGANAS: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.BEANUT: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.PICKAXE: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.SUN_CAP: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.FLIP_FLOPS: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.ICE_CREAM: ItemData(ItemClassification.progression, 4, ItemGroup.ITEM, Area.BASTO),
    ItemName.ROYAL_CAPE: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.MINIGAME_TICKET: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.LEI: ItemData(ItemClassification.filler, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.VACATION_SHIRT: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.ROYAL_CANE: ItemData(ItemClassification.filler, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.EMPTY_BOTTLE: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, Area.BASTO),
    ItemName.VIKING_HELMET: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, Area.BASTO),
    ...
    ItemName.PINE_NEEDLES_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.OAKLAVILLE),
    ItemName.SQUIRREL_PHOTO_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.OAKLAVILLE),
    ItemName.FISHERMANS_WHISTLE_TAPE: ItemData(ItemClassification.progression, 1, ItemGroup.CASSETTE, Area.STANHAMN),
    ItemName.SMILING_HUNTSMAN_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.STANHAMN),
    ItemName.NAUT_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.STANHAMN),
    ItemName.PLACE_IN_SUN_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.STANHAMN),
    ItemName.FISHERMANS_TUNE_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.STANHAMN),
    ItemName.RATSKULLZ_THEME_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.LOGCITY),
    ItemName.BIG_CITY_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.LOGCITY),
    ItemName.HUSTLE_BUSTLE_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.LOGCITY),
    ItemName.HOP_SKIP_STEP_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.LOGCITY),
    ItemName.ON_THE_HOUR_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.LOGCITY),
    ItemName.LIFE_THROUGH_LENS_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.KIIRUBERG),
    ItemName.PETTING_DEER_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.KIIRUBERG),
    ItemName.STORIES_OF_SNOW_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.KIIRUBERG),
    ItemName.TALL_SHY_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.KIIRUBERG),
    ItemName.NIGHT_JAM_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.BASTO),
    ItemName.WARM_DAYS_NIGHT_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.BASTO),
    ItemName.ONE_BY_ONE_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.BASTO),
    ItemName.HAMMOCK_DAYS_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.BASTO),
    ItemName.SAILORS_TUNE_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.BASTO),
    ItemName.SONG_OF_THE_SEA_TAPE: ItemData(ItemClassification.filler, 1, ItemGroup.CASSETTE, Area.BASTO),
}
