...
item_table: dict[str, ItemData] = {
    ...
    ItemName.FINGER: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.OAKLAVILLE),
    ItemName.TRIPOD: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, RegionName.OAKLAVILLE),
    ItemName.COWBOY_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.OAKLAVILLE),
    ItemName.WET_SOCKS: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, RegionName.OAKLAVILLE),
    ItemName.FJALLBJORN_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.OAKLAVILLE),
    ItemName.GHOST_GLASSES: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, RegionName.OAKLAVILLE),
    ItemName.SOAKED_SOCK: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.OAKLAVILLE),
    ItemName.MONSTER_MASK: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.OAKLAVILLE),
    ItemName.FRAMES_FILTERS: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ItemName.FISHING_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ItemName.HONK_ATTACHMENT: ItemData(progression_useful, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ItemName.UMBRELLA: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ItemName.OLD_KEY: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ItemName.HARD_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ItemName.DIVING_HELMET: ItemData(ItemClassification.progression, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ItemName.RUBBER_BOOTS: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ...
    ItemName.PAPER_HAT: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ItemName.FLAG: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.STANHAMN),
    ...
    ItemName.SNEAKERS: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.LOGCITY),
    ...
    ItemName.SUN_CAP: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.BASTO),
    ...
    ItemName.VIKING_HELMET: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.BASTO),
    ItemName.FOOT_CAST: ItemData(ItemClassification.filler, 1, ItemGroup.ITEM, RegionName.BASTO),
    ItemName.BERET: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.BASTO),
    ItemName.ROYAL_CROWN: ItemData(progression_deprioritized, 1, ItemGroup.ITEM, RegionName.BASTO),
    ...
    ItemName.FISHERMANS_WHISTLE_TAPE: ItemData(ItemClassification.progression, 1, ItemGroup.CASSETTE, RegionName.STANHAMN),  # noqa: E501
